...
Poza tym wybrany model charakteryzuje się najniższym błędem średniokwadratowym (RMSE), który wynosi 20.29928 Dodatkowo miara dopasowania modelu do danych (Rsquared) również jest jedną z wyższych.
